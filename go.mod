module github.com/nautes-labs/runtime-operator
...
require (
	...
	github.com/external-secrets/external-secrets v0.7.2
	github.com/go-kratos/kratos/v2 v2.5.0
	github.com/hashicorp/vault/api v1.9.0
	github.com/hashicorp/vault/api/auth/kubernetes v0.4.0
	github.com/nautes-labs/pkg v0.3.0-local.0.20230608071014-00005c86d93f
	k8s.io/api v0.26.0
...
require github.com/argoproj/argo-events v1.7.6
...
require (
	...
	k8s.io/kube-aggregator v0.23.2 // indirect
